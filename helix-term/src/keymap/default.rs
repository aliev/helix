...
pub fn default() -> HashMap<Mode, KeyTrie> {
    let normal = keymap!({ "Normal mode"
        ...
        "T" => till_prev_char,
        "F" => find_prev_char,
        "r" => file_sidebar_refresh_or_replace,
        "R" => file_sidebar_replace_or_rename,
        ...
        ":" => command_mode,
        "ret" => file_sidebar_action,
        "-" => file_sidebar,
        "H" => file_sidebar_toggle_hidden,

        "i" => insert_mode,
        "I" => insert_at_line_start,
        "a" => file_sidebar_append_or_create,
        "A" => insert_at_line_end,
        "o" => open_below,
        "O" => open_above,

        "d" => file_sidebar_delete_or_delete_selection,
